...
CFG = None  # __LAUNCHER_CONFIG__  (launch.py replaces this line when --accelerator gpu)
CFG = {**DEFAULTS, **(CFG or {})}
...
def publish(phase, **details):
    ...
    messages = {
        ...
        "model-ready": "Pesos Q4 verificados.",
        "server-starting": "Iniciando llama.cpp en las dos T4.",
...
def main():
    ...
    try:
        ...
        while time.time() < deadline:
            ...
            time.sleep(15)
        publish("auto-shutdown", reason="keepalive elapsed")
